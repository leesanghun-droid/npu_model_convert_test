...
{
    vnn_ReleaseGenderh5( graph, TRUE );
...
{
    return vnn_PostProcessGenderh5( graph );
}
    ...
    )
{
    ...
    if(vnn_UseImagePreprocessNode())
    {
        return vnn_PreProcessGenderh5_ImageProcess(graph, inputs, input_num);
    }
    */
    return vnn_PreProcessGenderh5( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateGenderh5( data_file_name, NULL,
